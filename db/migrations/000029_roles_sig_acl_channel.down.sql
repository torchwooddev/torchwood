-- 000029 逆序对称回滚：恢复 tw_roles 旧形态（000027 原文，PUBLIC EXECUTE
-- 默认 ACL）、DROP tw_set_document_acl / tw_secrets、回收 tw_system 的
-- CREATE ON public、卸载 pgcrypto（无其他依赖对象，失败即暴露）。
