...
func wireBootstrap(app lynx.App) (*boot.Bootstrap, func(), error) {
	...
	groups := server.NewGroups(repository, documentDB, userRepository, groupRepository, membershipRepository)
	...
	projects := server.NewProjects(repository, documentDB, database)
	...
	users := server.NewUsers(repository, documentDB, sessionService, database, userRepository, sessionRepository, groupRepository, membershipRepository)
