...
> 归档日期：2026-08-09
> 归档原因：本清单截止 2026-06-20（提交 `11af6f8`），已严重过期——§13「已知限制」中的 OAuth2、邮箱验证、密码找回、匿名登录、SMS OTP、微信登录等均已实现；内容已被代码与 `docs/roadmap.md` 取代。
> 后续信息源：`docs/roadmap.md`（规划与状态）、代码注释与集成测试。
